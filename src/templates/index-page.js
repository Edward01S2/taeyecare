...
return (
  ...
  {/* END COVID19-STUFF */}
    ...
    <div
      className="flex content-center justify-center w-screen h-[calc(100vh-10rem)] md:h-[calc(100vh-5rem)] lg:bg-fixed"
      style={{
    ...
    >
      <div class="flex items-center justify-center">
        <div className="p-4">
          <h2
            className="text-6xl leading-none tracking-widest text-center text-white font-optical text-shadow-md md:text-8xl lg:text-[6rem] xl:max-w-6xl xl:text-[8rem]"
    ...
    <Element name="services">
      <section className="-mt-12 text-center md:mx-8 xl:bg-transparent xl:mt-0">
        <div className="container mx-auto bg-white rounded-lg md:-mt-24 md:shadow-lg md:border md:border-gray-100 xl:bg-white">
          <div className="flex px-8 py-8 md:py-8 lg:p-8 xl:px-16 xl:py-10">
            <div className="flex flex-col lg:w-1/2 lg:pr-16">
              <h3 className="text-3xl font-semibold tracking-widest text-center uppercase md:pb-0 xl:pb-4 xl:text-4xl">
                Services
              </h3>
              ...
              <div className="py-4 border-b-2 border-gray-200 lg:py-4">
                <div className="flex items-center content-center mb-4 lg:mb-4">
                  <div className="relative mr-4">
                    <svg
                      className="z-0 w-10 h-10 fill-current text-ta-100"
                      viewBox="0 0 100 100"
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <circle cx="50" cy="50" r="50" />
                    </svg>
                    <Check className="absolute z-10 w-5 h-5 text-white stroke-current absolute-center" />
                  </div>
              ...
              <div className="py-8 border-b-2 border-gray-200">
                <div className="flex items-center content-center mb-4">
                  <div className="relative mr-4">
                    ...
                    <Eye className="absolute z-10 w-5 h-5 text-white stroke-current absolute-center" />
                  </div>
                  <h3 className="text-lg font-medium text-gray-800">
                    {services.item2}
                  </h3>
              ...
              <div className="py-8">
                <div className="flex items-center content-center mb-4">
                  <div className="relative mr-4">
                    ...
                    <Clip className="absolute z-10 w-5 h-5 text-white stroke-current absolute-center" />
                  </div>
                  <h3 className="text-lg font-medium text-gray-800">
                    {services.item3}
                  </h3>
          ...
          <div className="flex flex-col p-8 py-24 md:py-16 md:items-center lg:flex-row">
            ...
            <div className="pt-16 md:w-1/2 md:pt-0">
              <div className="text-center">
                <h3 className="pb-8 text-2xl font-semibold tracking-widest text-center uppercase md:mt-8">
                  Appointments
                </h3>
    ...
    <section className="bg-ta-200">
      <div className="container px-12 pt-16 pb-8 mx-auto text-white md:py-16 md:px-8">
        <h3 className="pb-8 text-2xl font-semibold tracking-widest text-center lg:text-3xl">
          Insurances Accepted
        </h3>
        ...
        <div className="container flex flex-col mx-auto md:py-16 lg:px-8 xl:flex-row xl:px-0 xl:py-24">
          ...
          <div className="flex flex-col content-center justify-center mx-4 mt-16 text-gray-800 bg-white rounded-t-lg shadow-lg order-0 md:mx-8 md:my-0 lg:mx-0 xl:w-1/2">
            <div className="z-0 p-8 pb-12 md:px-8 md:pt-12 md:pb-8">
              <h3 className="pb-8 text-4xl font-semibold tracking-widest text-center text-black uppercase font-optical">
                Ta Eye Associates
              </h3>
              <div className="flex flex-col content-center justify-center md:flex-row">
                  ...
                  <ul>
                    <li className="flex items-center content-center mb-6">
                      <div className="relative mr-2">
                        <svg
                          className="z-0 w-8 h-8 fill-current text-ta-100"
                          viewBox="0 0 100 100"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <circle cx="50" cy="50" r="50" />
                ...
                <div className="hidden pb-8 md:hidden lg:block lg:w-1/3 xl:hidden">
                  <p
                ...
                <div className="md:w-1/2 md:pl-12 lg:w-1/3 lg:p-0 xl:w-1/2">
                  <h3 className="pb-2 font-semibold text-left text-black">
                    Hours
                  </h3>
    ...
    <Element name="team">
      <section className="pt-16 xl:pt-24">
        <div className="container mx-auto text-center xl:pb-8">
          <h3 className="pb-12 text-4xl font-semibold tracking-widest text-center uppercase lg:pb-8">
            Our Team
          </h3>
          {staff.doctors.map(doc => (
            <div className="flex flex-col items-center pb-8 lg:flex-row lg:pl-8">
              <div
                className="flex-none w-64 h-64 overflow-hidden rounded-full shadow-inner img-circle"
                style={{
              ...
              <div className="flex-shrink p-8 text-left md:px-16">
                <div className="">
                  <h4 className="inline-block mb-4 text-2xl font-bold border-b-4 border-ta-100">
                    {doc.name}{" "}
    ...
    <section className="pt-16 pb-8 text-blue-100 bg-ta-200">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row md:flex-wrap md:justify-center md:content-center md:px-16">
          {staff.staff.map(usr => (
            <div className="flex items-center pb-8 pl-8 md:w-1/2 md:px-2 xl:w-1/3">
              <div
                className="flex-none w-24 h-24 overflow-hidden rounded-full shadow-inner img-circle"
                style={{
    ...
    <Element name="contact">
      <section className="pt-16 bg-gray-100 xl:pt-24">
        <Form
          formatPhone={formatPhone(settings.phone)}
          phone={settings.phone}
        />
        <GatsbyImage image={image2.childImageSharp.gatsbyImageData} className="z-0" />
      </section>
    </Element>
  </div>
);
